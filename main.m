...
% sigma = 0.02: eta = 5e-3, u = 4e-3, delta = 0.1, T = 7500
% sigma = 0.05: eta = 2e-3, u = 6e-3, delta = 0.15, T = 7500
...
fname = sprintf('dist_routing_sigma_%1.2f.mat', sigma);
save(fname);
